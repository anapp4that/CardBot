  ...
  controller.on("app_mention", function(bot, message){
        ...
        switch (action) {
          ...
          case ("remove"):
              ...
              if (object == "card") {
                bot.reply(message, "Im sorry, You can not remove a card at the moment.");
              }
              else if(object == "match"){
                bot.reply(message, "Im sorry, You can not remove a match at the moment");
              }
              else {
          ...
          case ("view"):
              ...
              if (object == "card") {
                bot.reply(message, "Im sorry, You can not view a card at the moment.");
              }
              else if(object == "match"){
                bot.reply(message, "Im sorry, You can not view a match at the moment");
              }
              else {
            ...
            break;
          default:
            bot.reply(message, "I dont recognize that command. \nUse the help command to see avaliable commands")
        }
